...
public class ValidateCodeFilter extends OncePerRequestFilter implements InitializingBean {
    ...
    public void afterPropertiesSet() throws ServletException {
        ...
        urlMap.put(CustomSecurityProperties.DEFAULT_LOGIN_PROCESSING_URL_FORM, ValidateCodeType.IMAGE);
        addUrlToMap("/user/*", ValidateCodeType.IMAGE);

        urlMap.put(CustomSecurityProperties.DEFAULT_LOGIN_PROCESSING_URL_MOBILE, ValidateCodeType.SMS);
